...
export default function PlanTrackerCaseStudy() {
  const { lang } = useLanguage();
  const cs = getContent(lang).planTrackerCaseStudy;
  const s = cs.sections;
  const repo = "https://github.com/Ixo22/plan-tracker";
  const demo = "https://plangrid.vercel.app/demo";
